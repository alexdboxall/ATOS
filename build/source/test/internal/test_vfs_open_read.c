...
void test_file_read(void) {
    ...
    struct uio io = uio_construct_read(buffer, 9, 0);
...
void test_file_read_with_offset(void) {
    ...
    */
    ...
    struct uio io = uio_construct_read(buffer, 20, 5);
    status = vfs_read(node, &io);
...
void test_file_read_way_past_end(void) {
    ...
    struct uio io = uio_construct_read(buffer, 5, 100);
    status = vfs_read(node, &io);
...
void test_double_file_read(void) {
    ...
    struct uio io = uio_construct_read(buffer, 5, 0);
    status = vfs_read(node, &io);
    assert(status == 0);
