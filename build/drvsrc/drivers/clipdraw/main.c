...
void _driver_entry_point() {
    ...
    struct region shadow_2 = region_create_rounded_rectangle(101, 101, 499, 399, 10);
    struct region shadow_3 = region_create_rounded_rectangle(102, 102, 498, 398, 10);
    struct region shadow_4 = region_create_rounded_rectangle(103, 103, 497, 397, 10);
